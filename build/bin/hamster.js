...
// include: /tmp/tmpqn_bws_0.js
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/hamster.data';
      var REMOTE_PACKAGE_BASE = 'hamster.data';
...
Module['FS_createPath']("/assets", "sounds", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/hamster.data');

      };
      Module['addRunDependency']('datafile_bin/hamster.data');
    ...
    loadPackage({"files": [{"filename": "/assets/.keepme", "start": 0, "end": 0}, {"filename": "/assets/gfx/space.png", "start": 0, "end": 45918}, {"filename": "/assets/sounds/Explosions1.wav", "start": 45918, "end": 138006, "audio": 1}, {"filename": "/assets/sounds/Laser_Shoot11.wav", "start": 138006, "end": 152408, "audio": 1}, {"filename": "/assets/sounds/bg-music.wav", "start": 152408, "end": 3146628, "audio": 1}, {"filename": "/assets/sounds/lose9.wav", "start": 3146628, "end": 3230254, "audio": 1}, {"filename": "/assets/sounds/thruster.wav", "start": 3230254, "end": 3325968, "audio": 1}], "remote_package_size": 3325968});

  })();

// end include: /tmp/tmpqn_bws_0.js
// include: /tmp/tmp7nu8ossb.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['ENVIRONMENT_IS_PTHREAD'] || Module['$ww']) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp7nu8ossb.js
// include: /tmp/tmp1498zf1g.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1498zf1g.js
...
// end include: preamble.js
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(InitSession|SetRacerName|StartRace|FinishRace|invoke_.*|__asyncjs__.*)$/;
...
var __Z35ma_device__on_notification_unlockedP9ma_device = Module['__Z35ma_device__on_notification_unlockedP9ma_device'] = createExportWrapper('_Z35ma_device__on_notification_unlockedP9ma_device');
...
var ___start_em_js = Module['___start_em_js'] = 105332;
var ___stop_em_js = Module['___stop_em_js'] = 107478;
